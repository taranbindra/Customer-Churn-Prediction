...
# Sidebar setup
st.sidebar.image("E:\Customer_churn_prediction\pythonProject\images\image.jpg", use_container_width=True)  # Display Pic 1
...
# App Header
st.image("E:\Customer_churn_prediction\pythonProject\images\image2.png", use_container_width=True)  # Display Pic 2
...
with left_col:
    ...
    feature_importance_df = pd.read_excel(r"E:\Customer_churn_prediction\pythonProject\data\feature_importance.xlsx", usecols=["Feature", "Feature Importance Score"])
